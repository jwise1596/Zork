...
namespace Zork
{
    internal class Program
    {
        ...
        private static void InitializeRoomDescriptions()
        {
            ...
            Rooms[1,1].Description = "This is an open field west of the white house, with a baorded front door."; //West of House
            ...
            Rooms[2,0].Description = "This is dimly lit forest, with large trees all around. To the east, there appears to be sunlight."; //Dense Woods
